...
- Genuine changed-input teaching replay. Capture/save alone is insufficient.
...
exclude reference apps and local diagnostics. Manual signed downloads are the beta
update path. Automatic update controls remain disabled.
