...
// Both exact versions generated byte-identical stable and experimental schemas.
pub const COMPATIBLE_CODEX_VERSIONS: [&str; 2] = [CODEX_VERSION, "codex-cli 0.155.0-alpha.9.2"];
...
mod tests {
    ...
    fn pinned_runtime_metadata_matches_generated_schema_fixtures() {
        ...
        assert_eq!(manifest["policy"]["allowUnknownVersions"], false);
    ...
    fn pinned_schema_retains_required_methods_and_named_permission_boundary() {
        let schema: Value = serde_json::from_str(include_str!("../../../research/codex-app-server/0.155.0-alpha.9/experimental/codex_app_server_protocol.v2.schemas.json")).unwrap();
        ...
        let server_requests = include_str!(
            "../../../research/codex-app-server/0.155.0-alpha.9/experimental/ServerRequest.ts"
        );
