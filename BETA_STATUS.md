...
| Component | Status |
| --- | --- |
| iPhone and iPad | Release 1.0 (52), containing Goal mode, notification setup feedback, and the reading-anchor fix, is uploaded, processed, approved for external testing, and installed through internal TestFlight on the iPhone Air. A background completion notification appeared on the iPhone Air and opened the correct QA conversation when tapped. Public enrollment remains unopened. |
